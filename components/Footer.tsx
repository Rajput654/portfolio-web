      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <Link href="/" className="text-xl font-bold tracking-tight text-slate-900 mb-4 block">
              Portfolio<span className="text-blue-600">.</span>
            </Link>
            <p className="text-slate-600 max-w-sm">
              Building scalable, accessible, and performant web applications for the modern internet.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-slate-200">
          ...
          {/* Social Icons mapped to the custom SVGs */}
          <div className="flex space-x-4 text-slate-500">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-slate-900 transition-colors" aria-label="GitHub">
              <GithubIcon size={20} />
            </a>
